...
public class Color {
    ...
    public Color(int alpha, int red, int green, int blue) {
        this.a = MathUtils.clamp(alpha, 0, 255);
        this.r = MathUtils.clamp(red, 0, 255);
        this.g = MathUtils.clamp(green, 0, 255);
        this.b = MathUtils.clamp(blue, 0, 255);
     ...
     * @return the interpolated color (0 = start, 1 = end)
     */
    public static Color fade(Color start, Color end, double progress) {
        return new Color(
                MathUtils.lerp(start.a, end.a, (float) progress),
                MathUtils.lerp(start.r, end.r, (float) progress),
                MathUtils.lerp(start.g, end.g, (float) progress),
                MathUtils.lerp(start.b, end.b, (float) progress));
    }

    public Color brighter() {
        return new Color(a, r + 30, g + 30, b + 30);
    }
